    ...
    public Request<GetShardIteratorRequest> marshall(GetShardIteratorRequest getShardIteratorRequest) {
        ...
        try {
          ...
          jsonWriter.object();
            ...
            if (getShardIteratorRequest.getStreamId() != null) {
                jsonWriter.key("StreamId").value(getShardIteratorRequest.getStreamId());
            }
            ...
            if (getShardIteratorRequest.getSequenceNumber() != null) {
                jsonWriter.key("SequenceNumber").value(getShardIteratorRequest.getSequenceNumber());
            }
