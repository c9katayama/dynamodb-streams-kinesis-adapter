        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamId", targetDepth)) {
                    context.nextToken();
                    streamDescription.setStreamId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("StreamViewType", targetDepth)) {
                    context.nextToken();
                    streamDescription.setStreamViewType(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("CreationRequestDateTime", targetDepth)) {
                    context.nextToken();
                    streamDescription.setCreationRequestDateTime(DateJsonUnmarshaller.getInstance().unmarshall(context));
                }
                if (context.testExpression("TableName", targetDepth)) {
                    context.nextToken();
                    streamDescription.setTableName(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
                ...
                if (context.testExpression("LastEvaluatedShardId", targetDepth)) {
                    context.nextToken();
                    streamDescription.setLastEvaluatedShardId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
