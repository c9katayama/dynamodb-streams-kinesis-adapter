    ...
    public ListStreamsResult unmarshall(JsonUnmarshallerContext context) throws Exception {
        ...
        while (true) {
            ...
            if (token == FIELD_NAME || token == START_OBJECT) {
                if (context.testExpression("StreamIds", targetDepth)) {
                    context.nextToken();
                    listStreamsResult.setStreamIds(new ListUnmarshaller<String>(StringJsonUnmarshaller.getInstance()).unmarshall(context));
                }
                if (context.testExpression("LastEvaluatedStreamId", targetDepth)) {
                    context.nextToken();
                    listStreamsResult.setLastEvaluatedStreamId(StringJsonUnmarshaller.getInstance().unmarshall(context));
                }
